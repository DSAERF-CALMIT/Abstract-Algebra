...
\item \begin{spacing}{1.2}The sufficient prerequisite of $G$, the subset of $M$, being a group is that every element in $G$ is invertible and for all $g_1, g_2 \in G$, we have $g_1^{-1} g_2 \in G$.
	...
	$\Longleftarrow:$ If $g \in G$ and $g$ is invertible and $g_1, g_2 \in G$, when $g_1 = g_2 = g \Longrightarrow g_1^{-1}g_2 = e \in G$ (Inverse), and $g_1^{-1} = g_1^{-1}e \in G$ (Identity). Additionally, $g_1^{-1}g_2 \in G \Longrightarrow (g_1^{-1})^{-1}g_2 = g_1 g_2 \in G$ (Closure). 
